...
(function($) {
    ...
    Slider.prototype = {
        ...
        bindDragEvent: function() {
            ...
            function success() {
                console.log($prog.parents('.tab-pane')[0])
                var parent_elem = $prog.parents('.tab-pane');
                parent_elem.find(".not_do").css("pointer-events","all");
                parent_elem.find(".not_do").removeAttr("disabled")
                parent_elem.find(".not_do").removeClass("not_do");
                $prog.css({
